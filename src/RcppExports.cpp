...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(computeColumnsPmfAndNeighborhoods(sexp, n0, nVec, epsilon, epsilon2, K, N, Y, X, A, S, rowSubsetI, CmVec, n2, phiV, tau, tau0, tauInt, maxNeighborhoodSize, cutOff));
    return __result;
END_RCPP
}
