...
#'
#' @description The function \code{simulateExample} generates a NPClustData object from a simulated dataset of desired dimensions
#' @import MASS
#' @import mvtnorm
#' @param n Number of subjects
#' @param p Number of variables
#' @param prop.X.miss Proportion of missing data
#' @param tau Standard deviation for (most) covariates
#' @param tau_0 Standard deviation for a few atypical subjects with high-variance covariates
#' @export
...
#' @param flip.sign A future extension. Currently set to FALSE.
